...
/**
 * Testing program for Part 2. By default, this reads from tests/test01-input.txt and
...
public class Part2Tester {
	...
	private static String inputFileName = "tests/test06-input.txt";
	private static String outputFileName = "tests/test06-output.txt";
	// --------------------------------------------------------------------------------------------
